...
やり方があるはずだ`,
    writing: {
      title: '記事制作',
      description: `クオリティーの高いWEBコンテンツは、新しい顧客を引き付ける磁石の役割を果たします。経済がどんどん拡大して行く時代は、とにかく大量の広告が新しい顧客との接点になっていた。しかし、経済が徐々に縮小していく時代は、創造性の高いクリエティブなコンテンツが新しい顧客との接点になっていくことは間違いありません。
...
Youtubeに載せるのであれば、最初の5秒でどうインパクトをつけるか、FacebookやTwitterであれば、音がでない状況で視聴者を引き込むにはどうするかなど、マーケット的な観点からエンターテイメント性の高い作品に仕上げていきます。`,
    ...
    contact: {
      title: 'お問い合わせ',
      notes: `メディア構築、コンテンツ作成をご希望の企業様から、面白いコンテンツを作ってみたいライターやクリエイターさん、そして、ただオフィスに遊びに来たいという変わり者の方まで、お気軽に下記のメールアドレスからご連絡下さい。
