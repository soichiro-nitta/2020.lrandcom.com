...
リーディング＆カンパニーでは、一つの物事を幅広い視点から捉え、独自性の高い記事を作成しています。`,
    link: '',
    button: 'もっと詳しく',
    src: 'https://lrandcom.kagoyacloud.com/static/contents'
  },
  website: {
    title: 'サイト制作',
    description: `その企業が面白そうかどうかは、HPを見ればすぐに分かります。
現在、まず企業を知ろうと思ったら、オフィスではなくHPをチェックするでしょう。良いHPの条件は、サクサク動くこと、シェイクスピアのような美しいコードで書かれていること、そして、納期というものを設けず、常にアップデートしていくことです。
リーディング＆カンパニーでは、デザインとエンジニアリングを両立し、コードを書きながらデザインをしていきます。`,
    src: 'https://lrandcom.kagoyacloud.com/static/website'
  },
  film: {
    title: '映像制作',
...
Youtubeに載せるのであれば、最初の5秒でどうインパクトをつけるか、FacebookやTwitterであれば、音がでない状況で視聴者を引き込むにはどうするかなど、マーケット的な観点からエンターテイメント性の高い作品に仕上げていきます。`,
    src: 'https://lrandcom.kagoyacloud.com/static/film'
  }
}
